...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/bitsend/bitsend/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the BitSendTestFramework, place overrides for the
...
with the bitsendd(s) being tested in a callback-based event loop; the other
...
The [`TestShell`](test-shell.md) class exposes the BitSendTestFramework
...
Test objects for interacting with a bitsendd node over the p2p interface.
