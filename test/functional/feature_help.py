...
class HelpTest(BitsendTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitsend with -h for help text")
        ...
        self.log.info("Start bitsend with -version for version information")
        ...
        self.log.info("Start bitsendd with -fakearg to make sure it does not start")
