...
class TestBitSendCli(BitSendTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitsend-cli getwalletinfo return expected wallet info")
            ...
            # Test bitsend-cli -generate with -rpcwallet in multiwallet mode.
