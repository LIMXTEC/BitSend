...
# Copyright (c) 2010-2020 The BitSend Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test objects for interacting with a bitsendd node over the p2p protocol.

The P2PInterface objects interact with the bitsendd nodes under test using the
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to BitSend Node: %s:%d' % (self.dstaddr, self.dstport))
