...
class TestShell:
    """Wrapper Class for BitSendTestFramework.

    The TestShell class extends the BitSendTestFramework
    ...
    class __TestShell(BitSendTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitSendTestFramework child class.
            self.num_nodes = 1
