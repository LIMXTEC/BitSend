...
class P2PPermissionsTests(BitSendTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitsendconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitsendconf, 'w', encoding="utf8") as f:
            f.write(newText)
