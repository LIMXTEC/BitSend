 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Bitsend,
 ...
 *
 * See https://github.com/bitsend/bitsend and https://bitsendcore.org/ for further information about the project.
 *
 * \section Navigation
...
static bool AppInit(int argc, char* argv[])
{
    ...
    if (HelpRequested(gArgs) || gArgs.IsArgSet("-version")) {
        ...
        {
            strUsage += "\nUsage:  bitsendd [options]                     Start " PACKAGE_NAME " Daemon\n";
    ...
    try
    {
        ...
        for (int i = 1; i < argc; i++) {
            if (!IsSwitchChar(argv[i][0])) {
                fprintf(stderr, "Error: Command line contains unexpected token '%s', see bitsendd -h for a list of options.\n", argv[i]);
                return false;
            }
        }
