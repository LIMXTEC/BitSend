...
#ifndef BITSEND_WALLET_SCRIPTPUBKEYMAN_H
#define BITSEND_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitSend Core wallet was originally a collection of unrelated private
...
#endif // BITSEND_WALLET_SCRIPTPUBKEYMAN_H
