...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 1; // 90% of 2016
        ...
        consensus.defaultAssumeValid = uint256S("0x0000000000000000002e63058c023a9a1de233554f28c7b21380b6c9003f36a8"); // 654683
