...
#ifndef BITSEND_CRYPTO_CHACHA_POLY_AEAD_H
#define BITSEND_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitsend.
 *
 ...
 *
 * The chacha20-poly1305@bitsend combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitsend cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitsend are relatively fast in
...
#endif // BITSEND_CRYPTO_CHACHA_POLY_AEAD_H
