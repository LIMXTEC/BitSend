...
/* Define this symbol if the MAC getentropy system call is available */
/* #undef HAVE_GETENTROPY */

/* Define this symbol if the MAC getentropy system call is available with
   sys/random.h */
...
/* Define this symbol if the MAC sysctl(KERN_ARND) is available */
...
#define PACKAGE_BUGREPORT "https://github.com/bitsend-project/bitsend/issues"
...
#define PACKAGE_URL "https://bitsend.io/"
