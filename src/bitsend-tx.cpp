...
static void SetupBitSendTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitsend-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitsend-tx [options] <hex-tx> [commands]  Update hex-encoded bitsend transaction\n" +
            "or:     bitsend-tx [options] -create [commands]   Create hex-encoded bitsend transaction\n" +
            "\n";
