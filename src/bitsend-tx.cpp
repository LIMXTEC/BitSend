...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitsend-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitsend-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitsend transaction") + "\n" +
              "  bitsend-tx [options] -create [commands]   " + _("Create hex-encoded bitsend transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CBitsendAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CBitsendAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitsend transaction
