...
help_text="""Test framework for bitsend utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/bitsend-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "bitsend-util-test.json", buildenv)
