...
#ifndef BITSEND_INTERFACES_NODE_H
#define BITSEND_INTERFACES_NODE_H
...
//! Top-level interface for a bitsend node (bitsendd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITSEND_INTERFACES_NODE_H
