...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BitSendUnits::SeparatorStyle separators=BitSendUnits::SeparatorStyle::STANDARD) const;
...
#endif // BITSEND_QT_TRANSACTIONTABLEMODEL_H
