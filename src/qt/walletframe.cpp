...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BitSendGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BitSendGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BitSendGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BitSendGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BitSendGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BitSendGUI::updateWalletStatus);
    connect(gui, &BitSendGUI::setPrivacy, walletView, &WalletView::setPrivacy);
