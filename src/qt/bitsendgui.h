...
public:
    ...
    explicit BitSendGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitSendGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitSend Transaction from file or clipboard */
