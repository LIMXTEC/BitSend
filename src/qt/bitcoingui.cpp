...
#ifdef ENABLE_WALLET
bool BitsendGUI::addWallet(WalletModel *walletModel)
{
    if(!walletFrame)
        return false;
...
bool BitsendGUI::removeWallet(WalletModel* walletModel)
{
...
bool BitsendGUI::setCurrentWalletBySelectorIndex(int index)
{
