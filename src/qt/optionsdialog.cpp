    ...
    mapper(nullptr)
{
    ...
    ui->bitsendAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitsendAtStartup);
    ...
    ui->bitsendAtStartup->setToolTip(ui->bitsendAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitsendAtStartup->setText(ui->bitsendAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitSendConfButton->setToolTip(ui->openBitSendConfButton->toolTip().arg(PACKAGE_NAME));
