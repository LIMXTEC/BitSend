...
//! Entry point for BitSendApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitSendApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitSendGUI tests.
void AppTests::guiTests(BitSendGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitSendGUI::consoleShown, this, &AppTests::consoleTests);
