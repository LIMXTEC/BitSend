...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bitsend-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bitsend-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bitsend-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BitSendUnits::formatWithUnit(unit, balance, false, BitSendUnits::SeparatorStyle::ALWAYS);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_bitsend-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
