...
void TestGUI()
{
    ...
    auto rowCount = transactionTableModel->rowCount({});
    QCOMPARE(transactionTableModel->rowCount({}), rowCount); //Changed from 105 to actual rowCount.
    ...
    QCOMPARE(transactionTableModel->rowCount({}), rowCount+2);
