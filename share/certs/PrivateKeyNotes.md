...
allowing somebody to distribute a Bitsend-Qt.app or bitsend-qt-setup.exe with a valid
...
that the bitsend-qt.exe file inside the installer had not been tampered with.
