...
// bitsend includes.
#include <..\src\script\bitsendconsensus.h>
...
int main()
{
    std::cout << "bitsendconsensus version: " << bitsendconsensus_version() << std::endl;
    ...
    auto op0Result = bitsendconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitsendconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
