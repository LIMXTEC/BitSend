...
##perform gitian builds
 ...
 Build limecoinxd and limecoinx-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit limecoinx=v${VERSION} ../limecoinx/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../limecoinx/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r limecoinx-${VERSION}-linux-gitian.zip *
	mv limecoinx-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit limecoinx=v${VERSION} ../limecoinx/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../limecoinx/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r limecoinx-${VERSION}-win-gitian.zip *
	mv limecoinx-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit limecoinx=v${VERSION} ../limecoinx/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
