BitSend Core version 0.16.1 is now available from:

  <https://bitsendcore.org/bin/bitsend-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitsendd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitsendd processes are cleaned up when tests end (sdaftuar)
