...
BitSend Core version 0.19.1 is now available from:

  <https://bitsendcore.org/bin/bitsend-core-0.19.1/>
...
From BitSend Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BitSend Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BitSend Core does not yet change appearance when
...
- #17488 fix "bitsendd already running" warnings on macOS (fanquake)
