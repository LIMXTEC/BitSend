BitSend Core version 0.16.3 is now available from:

  <https://bitsendcore.org/bin/bitsend-core-0.16.3/>
...
been discovered in BitSend Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` bitsendconsensus: invalid flags error should be set to `bitsendconsensus_err` (afk11)
