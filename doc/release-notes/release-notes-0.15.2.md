BitSend Core version *0.15.2* is now available from:

  <https://bitsendcore.org/bin/bitsend-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitsend-tx (TheBlueMatt)
