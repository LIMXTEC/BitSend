# Fuzzing BitSend Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing BitSend Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/bitsend/bitsend/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/bitsend/bitsend/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/bitsend/bitsend/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/bitsend/bitsend/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`bitsend-core/qa-assets`](https://github.com/bitsend-core/qa-assets) repo.

To fuzz `process_message` using the [`bitsend-core/qa-assets`](https://github.com/bitsend-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/bitsend-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`bitsend-core/qa-assets`](https://github.com/bitsend-core/qa-assets) repo.

Every single pull request submitted against the BitSend Core repo is automatically tested against all inputs in the [`bitsend-core/qa-assets`](https://github.com/bitsend-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BitSend Core more robust.
...
with certain assembly code from BitSend Core's code. See [developer notes on sanitizers](https://github.com/bitsend/bitsend/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing BitSend Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing BitSend Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing BitSend Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing BitSend Core using [Honggfuzz](https://github.com/google/honggfuzz):
