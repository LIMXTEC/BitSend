Bitsend Core version 0.17.x is now available from:

  <https://bitsendcore.org/bin/bitsend-core-0.17.x/>
...
- A new document introduces Bitsend Core's BIP174
  [Partially-Signed Bitsend Transactions (PSBT)](https://github.com/bitsend/bitsend/blob/0.17/doc/psbt.md)
