...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitsend repository."
  exit 1
fi
...
# See https://github.com/bitsend/bitsend/issues/16064
...
echo 'When compiling bitsendd, run `./configure` in the following way:'
echo
