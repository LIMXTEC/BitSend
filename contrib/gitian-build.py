...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitsend-core/gitian.sigs.git'])
    if not os.path.isdir('bitsend-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitsend-core/bitsend-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('bitsend'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitsend/bitsend.git'])
...
def build():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/bitsend-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/bitsend-*.zip build/out/bitsend-*.exe build/out/src/bitsend-*.tar.gz ../bitsend-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/bitsend-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/bitsend-*.tar.gz build/out/bitsend-*.dmg build/out/src/bitsend-*.tar.gz ../bitsend-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('cp inputs/bitsend-' + args.version + '-win-unsigned.tar.gz inputs/bitsend-win-unsigned.tar.gz', shell=True)
        subprocess.check_call(['bin/gbuild', '--skip-image', '--upgrade', '--commit', 'signature='+args.commit, '../bitsend/contrib/gitian-descriptors/gitian-win-signer.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call('cp inputs/bitsend-' + args.version + '-osx-unsigned.tar.gz inputs/bitsend-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call(['bin/gbuild', '--skip-image', '--upgrade', '--commit', 'signature='+args.commit, '../bitsend/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def verify():
    ...
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../bitsend/contrib/gitian-descriptors/gitian-linux.yml']):
        print('Verifying v'+args.version+' Linux FAILED\n')
        rc = 1

    print('\nVerifying v'+args.version+' Windows\n')
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../bitsend/contrib/gitian-descriptors/gitian-win.yml']):
        print('Verifying v'+args.version+' Windows FAILED\n')
        rc = 1

    print('\nVerifying v'+args.version+' MacOS\n')
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../bitsend/contrib/gitian-descriptors/gitian-osx.yml']):
        print('Verifying v'+args.version+' MacOS FAILED\n')
        rc = 1

    print('\nVerifying v'+args.version+' Signed Windows\n')
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../bitsend/contrib/gitian-descriptors/gitian-win-signer.yml']):
        print('Verifying v'+args.version+' Signed Windows FAILED\n')
        rc = 1

    print('\nVerifying v'+args.version+' Signed MacOS\n')
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../bitsend/contrib/gitian-descriptors/gitian-osx-signer.yml']):
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/bitsend/bitsend', help='Specify the URL of the repository. Default is %(default)s')
    ...
    if args.pull:
        ...
        os.chdir('../gitian-builder/inputs/bitsend')
        subprocess.check_call(['git', 'fetch', args.url, 'refs/pull/'+args.version+'/merge'])
