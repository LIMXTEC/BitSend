# Bootstrappable BitSend Core Builds

This directory contains the files necessary to perform bootstrappable BitSend
Core builds.
...
- 24GB of free disk space on the partition that the BitSend Core git repository
  resides in
...
For a BitSend Core depends development environment, simply invoke
...
From the top of a clean BitSend Core repository:
...
To use dongcarl's substitute server for BitSend Core builds after having
