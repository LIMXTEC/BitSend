...
WORKINGDIR="/tmp/bitsend"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/bitsend/Bitsend/bitsend-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/bitsend/Bitsend/"
VERSIONPREFIX="bitsend-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitsend-]<version>-[rc[0-9]] (example: bitsend-0.7.1-rc1)"
   echo "wget output:"
