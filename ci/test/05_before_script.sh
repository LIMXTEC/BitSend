...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitSend
else
  DOCKER_EXEC echo \> \$HOME/.bitsend
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitsend/bitsend/pull/18288#discussion_r433189350 for
  # details.
